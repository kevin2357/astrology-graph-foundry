...
BOUNDED_CALCULATION_PROFILE_VERSION = "agf.bounded_natal.calculation_profile.v1.12.0"
    ...
    *,
    ...
    profile = {
        ...
        "bounded_feature_policy": {
            ...
            "sect_and_triplicity": "assessed_with_sun_house_prerequisite_promotion",
            ...
            "harmonics": {
                "status": "assessed_with_invariant_sign_promotion" if config.include_harmonics else "disabled",
                "numbers": list(config.harmonic_numbers) if config.include_harmonics else [],
            },
            "derived_coordinate_aspects": "assessed_with_invariant_relationship_promotion",
            ...
            "structural_material": "invariant_subgraph_topology_counts_and_indexes_without_scores_patterns_or_claims",
