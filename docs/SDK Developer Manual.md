...
**Audience:** developers, report writers, game/tool authors, research users, future SDK maintainers.  
**Relationship to `how_to_use_sdk.md`:** `how_to_use_sdk.md` remains the practical quick-start and command reference. This manual explains how to think about the SDK, how to choose packages, how to consume outputs, and how the SDK fits into the larger project ecosystem.
...
- `how_to_use_sdk.md`: practical quick-start.
- `SDK Developer Manual.md`: this handbook.
